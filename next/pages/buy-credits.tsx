  ...
  return (
    <DashboardLayout>
      <div className="flex-1">
        <div className="w-full max-w-[1290px] mx-auto pt-0 px-5 md:px-[60px] pb-[32px]">
          ...
          <section className="mt-[47px]">
            <div className="mb-12">
              <div className="relative">
                <h2 className="text-[24px] font-semibold text-[#24272C] leading-[32px]">Buy Featured ad credits</h2>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              <div className="flex flex-col bg-white rounded-2xl border border-[#EDEDED] py-[22px] px-[20px] h-full shadow-sm">
                <img src="https://api.builder.io/api/v1/image/assets/TEMP/51bc3967e0cfacb3dec69f592eca5be9b62c263f?width=695" alt="Featured Credit" className="w-full h-[68px] lg:h-[78px] object-contain mb-3" />

                <div className="mb-5">
                  <h3 className="text-[18px] leading-[22px] font-medium text-[#E82121] font-albert mb-1">1-Pack</h3>
                  <p className="text-xs text-[#696665] font-albert leading-relaxed">Feature your car on Carzino to get top placement, more views, and faster sales.</p>
                </div>
                ...
                <button className="w-[70%] mx-auto bg-[#24272C] text-white py-2 px-4 rounded-2xl font-medium hover:bg-gray-800 transition-colors">Add to Cart</button>
              </div>

              <div className="flex flex-col bg-white rounded-2xl border border-[#EDEDED] py-[22px] px-[20px] h-full shadow-sm">
                <img src="https://api.builder.io/api/v1/image/assets/TEMP/82996bba11e0d8ddd6053ebbfa5710e3e259db53?width=695" alt="Featured Credit" className="w-full h-[68px] lg:h-[78px] object-contain mb-3" />

                <div className="mb-5">
                  <h3 className="text-[18px] leading-[22px] font-medium text-[#E82121] font-albert mb-1">5-Pack</h3>
                  <p className="text-xs text-[#696665] font-albert leading-relaxed">Feature your car on Carzino to get top placement, more views, and faster sales.</p>
                </div>
              ...
              <div className="flex flex-col bg-white rounded-2xl border border-[#EDEDED] py-[22px] px-[20px] h-full shadow-sm">
                <img src="https://api.builder.io/api/v1/image/assets/TEMP/f3af57c3a86baad09be458102b2d69988051b1e7?width=695" alt="Featured Credit" className="w-full h-[68px] lg:h-[78px] object-contain mb-3" />

                <div className="mb-5">
                  <h3 className="text-[18px] leading-[22px] font-medium text-[#E82121] font-albert mb-1">10-Pack</h3>
                  <p className="text-xs text-[#696665] font-albert leading-relaxed">Feature your car on Carzino to get top placement, more views, and faster sales.</p>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-[#EDEDED] p-6 md:col-span-2 shadow-sm">
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center gap-3">
                  <input type="number" min={1} className="w-40 px-3 py-2 rounded-lg border border-[#EDEDED] text-sm" placeholder="Credits" />
