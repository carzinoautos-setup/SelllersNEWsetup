        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center relative pt-[22px] px-4 pb-7">
            <div className="w-full text-center">
              ...
              <div className="text-gray-700 font-semibold">"Find it. Love it. Drive it. Carzino it."</div>
              <div className="text-gray-500 mt-2">Dealers: Exclusive early access now available- enjoy three 3-6 months of free listings.</div>
            </div>
          </div>
        </div>
      </div>
