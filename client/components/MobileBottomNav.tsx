...
export function MobileBottomNav() {
  ...
  const nav = (
    <div
      ref={navRef}
      className="fixed bottom-0 left-0 right-0 lg:hidden bg-black sm:bg-[#4A4A4A] border-t border-gray-200 z-50"
      role="navigation"
      aria-label="Mobile bottom navigation"
    >
      <div className="max-w-7xl mx-auto px-4 bg-black sm:bg-[#4A4A4A]" style={{paddingBottom: 'env(safe-area-inset-bottom)'}}>
        <div
