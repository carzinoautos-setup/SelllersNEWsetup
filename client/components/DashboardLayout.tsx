...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-albert overflow-x-hidden">
        ...
        <div className="flex-1 flex flex-col">
          ...
          >
            <img
              ...
              alt="vehicle"
              className="flex sm:hidden w-full h-auto object-cover mt-5 min-h-[20px] min-w-[20px]"
              style={{
                aspectRatio: "3.21",
