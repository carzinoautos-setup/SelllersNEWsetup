      ...
      <div className="space-y-5">
        ...
        <div className="border border-[#B2B2B2] rounded-2xl p-3">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* City */}
            <div className="space-y-2">
              <Label className="text-[13px] text-[#818181] font-dm">City</Label>
              <Input
            ...
            <div className="space-y-2 lg:col-span-3">
              <Label className="text-[13px] text-[#818181] font-dm">
                Enter your full address here and then select it from the
                choices.
              </Label>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center gap-1.5">
                  <div
                    className={`w-2 h-2 rounded-full ${passwordRequirements.hasNumber ? "bg-[#7ED321]" : "bg-[#B6B6B6]"}`}
                  />
                  <span
                    className={`text-xs font-albert ${passwordRequirements.hasNumber ? "text-[#7ED321]" : "text-[#B6B6B6]"}`}
                  >
                    One number
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <div
                    className={`w-2 h-2 rounded-full ${passwordRequirements.hasLowercase ? "bg-[#7ED321]" : "bg-[#B6B6B6]"}`}
                  />
                  <span
                    className={`text-xs font-albert ${passwordRequirements.hasLowercase ? "text-[#7ED321]" : "text-[#B6B6B6]"}`}
                  >
                ...
                <div className="flex items-center gap-1.5">
                  <div
                    className={`w-2 h-2 rounded-full ${passwordRequirements.hasUppercase ? "bg-[#7ED321]" : "bg-[#B6B6B6]"}`}
                  />
                  <span
                    className={`text-xs font-albert ${passwordRequirements.hasUppercase ? "text-[#7ED321]" : "text-[#B6B6B6]"}`}
                  >
                ...
                <div className="flex items-center gap-1.5">
                  <div
                    className={`w-2 h-2 rounded-full ${passwordRequirements.hasMinLength ? "bg-[#7ED321]" : "bg-[#B6B6B6]"}`}
                  />
                  <span
                    className={`text-xs font-albert ${passwordRequirements.hasMinLength ? "text-[#7ED321]" : "text-[#B6B6B6]"}`}
                  >
...
function ChevronDownIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 10 10" fill="none">
      <path
        d="M9.87722 2.52782C9.69674 2.33638 9.39483 2.32925 9.20434 2.50924L5.00757 6.48505L0.81128 2.50926C0.620796 2.32878 0.319357 2.3364 0.138405 2.52784C-0.0425481 2.71879 -0.0344624 3.02023 0.15651 3.20118L4.68043 7.487C4.77185 7.57368 4.88995 7.61748 5.00757 7.61748C5.12518 7.61748 5.24375 7.57368 5.3352 7.487L9.85911 3.20118C10.0501 3.02021 10.0582 2.71879 9.87722 2.52782Z"
        fill="currentColor"
      />
    </svg>
  );
...
function ChevronRightIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 17 16" fill="none">
      <path
        d="M13.25 5.5L8.25 10.5L3.25 5.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
