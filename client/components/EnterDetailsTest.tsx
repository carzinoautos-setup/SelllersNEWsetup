      ...
      <div className="p-7 rounded-2xl border border-[#B2B2B2] bg-white shadow-[0_1px_2px_0_rgba(0,0,0,0.30),0_2px_6px_2px_rgba(0,0,0,0.15)]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="relative">
            <div className="w-full h-[48px] rounded-2xl border-2 border-[#6B6B6B] bg-white px-4 py-2 flex items-center transition-colors focus-within:border-[#E82121]">
              <div className="text-[13.5px] text-[#050B20] font-dm">Enter your full name</div>
            </div>
          ...
          <div className="relative">
            <div className="w-full h-[48px] rounded-2xl border-2 border-[#6B6B6B] bg-white px-4 py-2 flex items-center transition-colors focus-within:border-[#E82121]">
              <div className="text-[13.5px] text-[#050B20] font-dm">Enter your city</div>
            </div>
          ...
          <div className="relative">
            <div className="w-full h-[48px] rounded-2xl border-2 border-[#6B6B6B] bg-white px-4 py-2 flex items-center transition-colors focus-within:border-[#E82121]">
              <div className="text-[13.5px] text-[#050B20] font-dm">Enter your state</div>
            </div>
          ...
          <div className="relative">
            <div className="w-full h-[48px] rounded-2xl border-2 border-[#6B6B6B] bg-white px-4 py-2 flex items-center transition-colors focus-within:border-[#E82121]">
              <div className="text-[13.5px] text-[#050B20] font-dm">Enter your zip code</div>
            </div>
          ...
          <div className="relative">
            <div className="w-full h-[48px] rounded-2xl border-2 border-[#6B6B6B] bg-white px-4 py-2 flex items-center transition-colors focus-within:border-[#E82121]">
              <div className="text-[13.5px] text-[#050B20] font-dm">Enter your email address</div>
            </div>
          ...
          <div className="relative">
            <div className="w-full h-[48px] rounded-2xl border-2 border-[#6B6B6B] bg-white px-4 py-2 flex items-center justify-between transition-colors focus-within:border-[#E82121]">
              <div className="flex flex-col justify-center">
                <div className="text-[13.5px] text-[#050B20] font-dm">Yes</div>
              </div>
          ...
          <div className="relative">
            <div className="w-full h-[48px] rounded-2xl border-2 border-[#6B6B6B] bg-white px-4 py-2 flex items-center transition-colors focus-within:border-[#E82121]">
              <div className="text-[13.5px] text-[#050B20] font-dm">(206)</div>
            </div>
          ...
          <div className="relative lg:col-span-3">
            <div className="w-full h-[48px] rounded-2xl border-2 border-[#6B6B6B] bg-white px-4 py-2 flex items-center transition-colors focus-within:border-[#E82121]">
              <div className="text-[13.5px] text-[#050B20] font-dm">Enter address</div>
            </div>
          ...
          <div className="relative">
            <div className="w-full h-[48px] rounded-2xl border-2 border-[#6B6B6B] bg-white px-4 py-2 flex items-center transition-colors focus-within:border-[#E82121]">
              <div className="text-[13.5px] text-[#050B20] font-dm">Auto populates from google maps</div>
            </div>
