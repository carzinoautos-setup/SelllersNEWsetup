    ...
    <footer className="left-0 w-screen relative">
      ...
      <div className="w-full bg-[#f8f8f8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center relative py-7 px-4">
      ...
      <div className="w-full bg-[#24272C] text-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-16 py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-10">
            ...
            <div>
              <h4 className="font-medium text-[18px] leading-7 mb-4">
                Popular used car
              </h4>
              <nav className="space-y-3 text-sm opacity-80">
            ...
            <div>
              ...
              <div className="space-y-3">
                <input
                  ...
                  className="w-full rounded-lg h-12 px-4 bg-white/5 placeholder-white/60 text-white"
                />
                <button className="w-full bg-red-600 rounded-lg h-12 text-white font-medium">
                  Send
                </button>
              </div>
            </div>
          ...
          <div className="border-t border-white/10 pt-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <a className="w-10 h-10 rounded-full bg-white/8 flex items-center justify-center">
                ...
                >
                  <path
                    d="M8 19c7.333 0 11.333-6 11.333-11.333v-.516A8.139 8.139 0 0020 6.25a8.185 8.185 0 01-2.357.646A4.11 4.11 0 0019.448 4.4a8.224 8.224 0 01-2.606.996A4.103 4.103 0 0013.847 3c-2.266 0-4.103 1.838-4.103 4.103 0 .322.036.636.106.937A11.64 11.64 0 013 4.998a4.103 4.103 0 001.27 5.478A4.066 4.066 0 012.8 10.5v.052c0 2.018 1.436 3.703 3.342 4.088a4.09 4.09 0 01-1.853.07c.523 1.633 2.04 2.82 3.837 2.853A8.233 8.233 0 013 18.54a11.616 11.616 0 006.29 1.84"
                    stroke="currentColor"
                    strokeWidth="1.2"
                    strokeLinecap="round"
