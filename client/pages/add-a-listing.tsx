            ...
            <div className="max-w-[1200px] mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="relative group">
                  ...
                  <input
                    className="w-full h-14 rounded-md border border-[#E6E6E6] px-4 text-[15px] focus:border-[#E82121] focus:ring-0"
                    type="text"
                ...
                <div className="relative md:col-span-3 group">
                  ...
                  <button type="button" className="w-full h-14 rounded-md border border-[#E6E6E6] px-4 flex items-center justify-between">
                    ...
                    <span className="flex items-center gap-2">
                      ...
                      <svg width="12" height="12" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.87 2.53C9.69 2.34 9.39 2.33 9.2 2.51L5 6.49 0.8 2.51C0.61 2.33 0.31 2.34 0.13 2.53C-0.05 2.72 -0.04 3.02 0.15 3.2L4.67 7.49C4.76 7.57 4.88 7.62 5 7.62C5.12 7.62 5.24 7.57 5.33 7.49L9.85 3.2C10.04 3.02 10.05 2.72 9.87 2.53Z" fill="currentColor" stroke="#E82121"/></svg>
                    </span>
                  </button>
                </div>
