          ...
          <section className="w-full mb-8">
            <div className="max-w-[1480px] mx-auto">
              ...
              >
                ...
                <div className="bg-white rounded-2xl pl-[2px] mt-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-10 items-start p-6">
                    {/* Features Column */}
