                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  ...
                  <div className="relative xl:col-span-2">
                    <div className="w-full h-[60px] border border-[#E1E1E1] rounded-xl bg-white relative">
                      ...
                      <svg
                        className="absolute right-4 top-1/2 transform -translate-y-1/2 w-2.5 h-2.5 pointer-events-none"
                        viewBox="0 0 10 10"
                        fill="none"
                      >
                        <path
                  ...
                  <div className="space-y-4">
                    <h3 className="text-[16px] font-medium text-[#050B20] font-dm leading-7 mb-4">
                      ...
                      >
                        ...
                        <svg
                          className="w-4 h-4 text-[#E82121] sm:hidden transform transition-transform"
                          style={{
                            transform: openSections.convenience
                              ? "rotate(180deg)"
                              : "rotate(0deg)",
                          }}
                          viewBox="0 0 10 6"
                    ...
                    <div
                      className={
                        openSections.convenience
                          ? "block sm:block space-y-4"
                          : "hidden sm:block space-y-4"
                      }
                    >
                      <label className="flex items-center gap-2.5 cursor-pointer">
                        <div className="w-5 h-5 rounded border border-[#B2B2B2] bg-white flex items-center justify-center"></div>
                        <span className="flex-1 text-sm text-[#050B20] font-dm leading-5 break-words">
                          Navigation System
                        </span>
                      </label>
                    ...
                    <h3 className="text-[16px] font-medium text-[#050B20] font-dm leading-7 mb-4">
                      ...
                      >
                        ...
                        <svg
                          className="w-4 h-4 text-[#E82121] sm:hidden transform transition-transform"
                          style={{
                            transform: openSections.entertainment
                              ? "rotate(180deg)"
                              : "rotate(0deg)",
                          }}
                          viewBox="0 0 10 6"
                  ...
                  <div className="space-y-4">
                    <h3 className="text-[16px] font-medium text-[#050B20] font-dm leading-7 mb-4">
                      <button
                        ...
                        className="w-full flex items-center justify-between gap-2.5 text-[16px] font-medium p-0 m-0"
                        onClick={() =>
                          setOpenSections((s) => ({ ...s, safety: !s.safety }))
                        }
