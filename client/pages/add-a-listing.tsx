                  ...
                  <CollapsibleSection title={'Features'} id={'features'} isOpen={openSections.features} onToggle={() => handleToggle('features')}>
                    ...
                    <div className="flex flex-col gap-4">
                      <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Navigation System</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Remote Start</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Keyless Entry</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Hands-Free</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Power Folding Side Mirrors</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Rain-Sensing Wipers</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Homelink</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Split-Folding Rear Seats</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                  ...
                  <CollapsibleSection title={'Interior'} id={'interior'} isOpen={openSections.interior} onToggle={() => handleToggle('interior')}>
                    ...
                    <div className="flex flex-col gap-4">
                      <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Leather Seats</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" defaultChecked />
                        <div className="w-5 h-5 rounded bg-[#E82121] flex items-center justify-center">
                        ...
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Heated Seats</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Sunroof /Panoramic Roof</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Heated Steering Wheel</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Touchscreen Display</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Ventilated / Cooled Seats</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Memory Driver Seat Settings</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Ambient Interior Lighting</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Rubber Flooring</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                  ...
                  <CollapsibleSection title={'Exterior'} id={'exterior'} isOpen={openSections.exterior} onToggle={() => handleToggle('exterior')}>
                    ...
                    <div className="flex flex-col gap-4">
                      <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Alloy Wheels</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" defaultChecked />
                        <div className="w-5 h-5 rounded bg-[#E82121] flex items-center justify-center">
                        ...
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">LED Headlights</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Fog Lights</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Roof Rack</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Tinted Windows</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Power Tailgate</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Tow Hitch / Towing Package</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Running Boards</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Body Kit/Sport Package</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                  ...
                  <CollapsibleSection title={'Safety Options'} id={'safety'} isOpen={openSections.safety} onToggle={() => handleToggle('safety')}>
                    ...
                    <div className="flex flex-col gap-4">
                      <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Airbags</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" defaultChecked />
                        <div className="w-5 h-5 rounded bg-[#E82121] flex items-center justify-center">
                        ...
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Airbag - Passenger</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Anti-lock Braking System</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Backup Camera</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Lane Departure Warning</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Adaptive Cruise Control</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Parking Sensors</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Automatic High Beams</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Tire Pressure Monitoring System</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                  ...
                  <CollapsibleSection title={'Technology'} id={'technology'} isOpen={openSections.technology} onToggle={() => handleToggle('technology')}>
                    ...
                    <div className="flex flex-col gap-4">
                      <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Apple CarPlay/Android Auto</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" defaultChecked />
                        <div className="w-5 h-5 rounded bg-[#E82121] flex items-center justify-center">
                        ...
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Bluetooth</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                      ...
                      <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Wireless Phone Connectivity</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Rear Seat Entertainment Screens</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">DVD Player</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Premium Sound System</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Steering Wheel Audio Controls</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Wi-Fi Hotspot Capability</span>
                      </label>
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" className="hidden" />
                        <div className="w-5 h-5 border border-[#B2B2B2] rounded bg-white flex items-center justify-center">
                        </div>
                        <span className="text-[12px] text-[#050B20] font-['Albert_Sans'] leading-[25px]">Voice Command System</span>
                      </label>
                    </div>
                  </CollapsibleSection>
