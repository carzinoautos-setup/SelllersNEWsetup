          ...
          <div className="flex flex-col xl:flex-row gap-8">
            <div className="flex-1">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  <div className="w-full lg:w-[428px] flex-shrink-0">
                    ...
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      />
                      <div className="flex-1">
                        <h4 className="text-[#30313D] font-albert text-sm font-semibold mb-3">
                          Featured Ad Credit
                        </h4>
                        <p className="text-[#30313D] font-albert text-xs">
                          1 Featured Credit
                        </p>
                      </div>
                      <div className="text-[#30313D] font-albert text-sm text-right">
                        $5
                      </div>
                    </div>
                    ...
                    <div className="border-t border-b border-[#8C8C8C] py-[18px] space-y-4">
                      <div className="flex justify-between items-center">
                        <span className="text-[#30313D] font-albert text-sm">
                          Subtotal
                        </span>
                        <span className="text-[#30313D] font-albert text-sm">
                          $5
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-[#8C8C8C] font-albert text-sm">
                          $.96
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-[#30313D] font-albert text-sm font-medium">
                          Total
                        </span>
                        <span className="text-[#30313D] font-albert text-sm font-medium">
                          $5.96
                  ...
                  <div className="flex-1 bg-white rounded-lg shadow-[-4px_0_20px_0_rgba(0,0,0,0.05)] p-11 max-w-[778px]">
                    <div className="max-w-[405px] mx-auto space-y-[14px]">
                      {/* Contact Information */}
                      <div>
                        <h4 className="text-[#24272C] font-inter text-base font-medium mb-1">
                          Contact information
                        </h4>
                        <div className="flex items-center p-3 bg-[#F7F7F7] rounded-[7px] border border-[#E7EAEB]">
                          <span className="text-[#4D4D4D] font-inter text-sm font-medium mr-2">
                            Email
                          </span>
                          <span className="text-[#333] font-inter text-sm">
                            Username@gmail.com
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-[13px]">
                        <h4 className="text-[#333] font-inter text-base font-medium">
                          Payment method
                        </h4>

                        {/* Card Information */}
                        <div className="space-y-1">
                          <label className="text-[#666] font-inter text-sm font-medium">
                            Card information
                          </label>
                          <div className="border border-[#E7EAEB] rounded-[7px] bg-white">
                            ...
                            <div className="flex items-center justify-between p-[9px_15px] border-b border-[#E7EAEB]">
                              <div className="flex items-center">
                                ...
                                <span className="text-black/50 font-inter text-sm">
                                  Enter text
                                </span>
                              </div>
                              <div className="flex items-center gap-[3px]">
                                ...
                                >
                                  ...
                                  <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M13.764 13.3928V7.69141L23.9116 7.70051V9.27541L22.7387 10.5288L23.9116 11.7937V13.402H22.039L21.0438 12.3038L20.0557 13.4061L13.764 13.3928Z"
                                    fill="#FFFFFE"
                                  />
                                  <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M14.4418 12.7692V8.32031H18.2141V9.3452H15.6632V10.0409H18.1532V11.0487H15.6632V11.732H18.2141V12.7692H14.4418Z"
                                    fill="#016FD0"
                                  />
                                  <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M18.1953 12.7691L20.2826 10.5421L18.1952 8.32031H19.8108L21.0863 9.73035L22.3654 8.32031H23.9116V8.35532L21.8687 10.5421L23.9116 12.706V12.7691H22.3499L21.0518 11.3449L19.767 12.7691H18.1953Z"
                                    fill="#016FD0"
                                  />
                                  <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M14.2374 2.63281H16.6834L17.5426 4.58366V2.63281H20.5624L21.0832 4.09438L21.6057 2.63281H23.9116V8.3342H11.7251L14.2374 2.63281Z"
                                    fill="#FFFFFE"
                                  />
                                  <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M14.7005 3.25L12.7264 7.69517H14.0803L14.4528 6.80501H16.4707L16.8429 7.69517H18.2304L16.2647 3.25H14.7005ZM14.8701 5.80744L15.4621 4.39236L16.0536 5.80744H14.8701Z"
                                    fill="#016FD0"
                                  />
                                  <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M18.2119 7.69508V3.25L20.115 3.25654L21.0943 5.98927L22.0799 3.25H23.9115V7.69508L22.7329 7.70551V4.65217L21.6204 7.69508H20.5446L19.4089 4.64174V7.69508H18.2119Z"
                                    fill="#016FD0"
                                  />
                                </svg>
                                <svg
                      ...
                      <div className="bg-white rounded-md shadow-[0_1px_1.5px_0_rgba(0,0,0,0.05)] p-4 space-y-3">
                        <div className="flex items-center justify-center gap-1">
                          <span className="text-[#A3A3A3] font-albert text-xs">
                            Powered by
                          </span>
                          <svg
                            className="w-12 h-[22px]"
                            viewBox="0 0 48 22"
                            fill="none"
                          >
                            <path
              ...
              <div className="bg-white border border-[#E1E1E1] rounded-2xl p-6 mb-6">
                <h3 className="font-dm text-[16px] font-medium mb-4">
                  Payment Methods
                </h3>
                ...
                <div className="space-y-4">
                  {methods.length === 0 ? (
                    ...
                    methods.map((m) => (
                      ...
                      >
                        <div>
                          <div className="font-dm text-[15px] text-[#050B20] font-medium">
                            {m.brand} •••• {m.last4}
                          </div>
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="px-3 py-2 bg-[#F9FBFC] border border-[#E1E1E1] rounded-md text-[#050B20]"
                          >
                            Remove
                          </button>
                        </div>
                ...
                >
                  <div className="col-span-2 md:col-span-1">
                    <label className="block text-[13px] text-[#050B20] mb-2">
                      Name on card
                    </label>
                    <input
                      name="name"
                      ...
                      className="w-full border border-[#E1E1E1] rounded-lg p-3"
                    />
                  </div>
                  ...
                  <div className="col-span-2">
                    ...
                    <textarea
                      ...
                      value={form.address}
                      onChange={handleChange}
                      className="w-full border border-[#E1E1E1] rounded-lg p-3 h-20"
                    />
                  </div>
                  ...
                  <div className="col-span-2 flex items-center gap-3">
                    <button
                      type="submit"
                      className="bg-black text-white px-6 py-3 rounded-xl font-dm text-[15px] font-medium"
                    >
                      Add payment method
                    </button>
                  ...
                  {invoices.map((inv) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <div
                          className={`text-[13px] ${inv.status === "Paid" ? "text-green-600" : inv.status === "Pending" ? "text-yellow-600" : "text-red-600"}`}
                        >
                          {inv.status}
                        </div>
                      </div>
            ...
            <div className="w-full xl:w-[380px]">
              <div className="bg-white border border-[#E1E1E1] rounded-2xl p-[30px]">
                <h3 className="text-[#050B20] font-albert text-xl font-medium mb-[24px]">
                  Billing summary
                </h3>
                <div className="space-y-4 mb-6">
                  <div className="flex justify-between items-center">
                    <span className="text-[#050B20] font-dm text-[15px]">
                      Outstanding
                    </span>
                    <span className="text-[#050B20] font-dm text-[15px] font-medium">
                      $45
                    </span>
                  </div>
