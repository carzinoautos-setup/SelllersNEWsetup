  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-white rounded-[15px] shadow-[0_6px_10px_4px_rgba(0,0,0,0.15),0_2px_3px_0_rgba(0,0,0,0.30)] overflow-hidden transform scale-[0.55] origin-center">
        {/* Red Check Icon */}
        <div className="absolute left-[15px] top-[18px] w-[56px] h-[56px] bg-[#E82121] rounded-full flex items-center justify-center">
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M34.1667 7.35L14.1667 27.35L5 18.1833L7.35 15.8333L14.1667 22.6333L31.8167 5L34.1667 7.35Z" fill="white"/>
          </svg>
        </div>
