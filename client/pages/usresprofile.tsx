              ...
              <div className="relative w-[280px]" ref={sellerTypeRef}>
                <div className="w-full h-[54px] rounded-xl border border-[#B2B2B2] bg-white px-4 shadow-sm focus-within:border-[#CF0D0D] transition-colors duration-150 relative">
                  <div className="h-full flex items-center">
                    <div className="absolute -top-2 left-4 bg-white px-1 text-[12px] text-black">Select Seller Type</div>
                    <div className="relative w-full">
                      ...
                      >
                        <div className="block flex-grow overflow-hidden text-left text-ellipsis whitespace-nowrap">{sellerType || 'Select Seller Type'}</div>
