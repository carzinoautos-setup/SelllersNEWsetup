          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4">
              <div className="relative flex-1" ref={sellerTypeRef}>
                ...
                >
                  <span className="truncate flex-1 text-left">{sellerType || 'Select Seller Type'}</span>
                ...
                {sellerTypeOpen && (
                  <ul role="listbox" className="absolute left-0 mt-2 w-full bg-white border border-[#E1E1E1] rounded-md shadow-lg z-50" style={{ minWidth: '420px', width: 'max(100%, 420px)' }}>
                ...
                <div className="pt-2 flex items-center justify-between">
                  <div>
                    ...
                    <div className="relative w-full" ref={listPhoneFormRef}>
                      ...
                      >
                        <span className="flex-1 text-left">{listPhone ? 'Yes' : 'No'}</span>
