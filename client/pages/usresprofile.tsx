        ...
        <div className="py-16 px-5">
          <div className="w-full max-w-[1280px] mx-auto">
            <div className="flex flex-col items-start justify-center border border-[#E4E4E4] rounded-[14px] p-5">
              <div className="flex flex-col lg:flex-row justify-start items-start gap-8 lg:gap-[167px] bg-white w-full max-w-[1280px]">

                <div className="flex-1 max-w-[896px] space-y-10 flex flex-row justify-start items-start">
