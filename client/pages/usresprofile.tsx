            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative w-[280px]" ref={listPhoneRef}>
                ...
                >
                  ...
                  <svg className="w-4 h-4 absolute right-4 top-1/2 transform -translate-y-1/2" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.86941 3.02782C9.68892 2.83638 9.38702 2.82925 9.19653 3.00924L4.99976 6.98505L0.803467 3.00926C0.612983 2.82878 0.311545 2.8364 0.130592 3.02784C-0.0503606 3.21879 -0.0422749 3.52023 0.148697 3.70118L4.67261 7.987C4.76404 8.07368 4.88214 8.11748 4.99976 8.11748C5.11737 8.11748 5.23594 8.07368 5.32738 7.987L9.8513 3.70118C10.0423 3.52021 10.0504 3.21879 9.86941 3.02782Z" fill="#CF0D0D"/></svg>
                </button>
              ...
              <div className="relative w-[280px]">
                <div className="w-full h-[54px] rounded-xl border border-[#B2B2B2] bg-white px-4 shadow-sm focus-within:border-[#CF0D0D] transition-colors duration-150 relative">
                  <div className="h-full flex items-center">
                    <div className="absolute -top-2 left-4 bg-white px-1 text-[12px] text-black">Do you sell new or used vehicles?</div>
                    <div className="relative w-full" ref={vehicleTypeRef}>
                      ...
                      >
                        <div className="block flex-grow overflow-hidden text-left text-ellipsis whitespace-nowrap">{vehicleType || 'Used'}</div>
                        <svg viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 ml-2"><path d="M9.86941 3.02782C9.68892 2.83638 9.38702 2.82925 9.19653 3.00924L4.99976 6.98505L0.803467 3.00926C0.612983 2.82878 0.311545 2.8364 0.130592 3.02784C-0.0503606 3.21879 -0.0422749 3.52023 0.148697 3.70118L4.67261 7.987C4.76404 8.07368 4.88214 8.11748 4.99976 8.11748C5.11737 8.11748 5.23594 8.07368 5.32738 7.987L9.8513 3.70118C10.0423 3.52021 10.0504 3.21879 9.86941 3.02782Z" fill="#CF0D0D"/></svg>
                      </button>
                ...
                <div className="h-full flex items-center">
                  ...
                  <div className="relative w-full" ref={vehicleTypeRef}>
                    <button
                      ...
                      aria-expanded={vehicleTypeOpen}
                    >
                      <span className="truncate flex-1 text-left">{vehicleType}</span>
                      <svg viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 ml-2"><path d="M9.86941 3.02782C9.68892 2.83638 9.38702 2.82925 9.19653 3.00924L4.99976 6.98505L0.803467 3.00926C0.612983 2.82878 0.311545 2.8364 0.130592 3.02784C-0.0503606 3.21879 -0.0422749 3.52023 0.148697 3.70118L4.67261 7.987C4.76404 8.07368 4.88214 8.11748 4.99976 8.11748C5.11737 8.11748 5.23594 8.07368 5.32738 7.987L9.8513 3.70118C10.0423 3.52021 10.0504 3.21879 9.86941 3.02782Z" fill="#CF0D0D"/></svg>
                    </button>
