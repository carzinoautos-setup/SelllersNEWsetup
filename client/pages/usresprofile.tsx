            ...
            <div className="flex flex-col items-center border border-[#E4E4E4] rounded-[14px] p-5">
              <div className="flex flex-col lg:flex-row justify-end items-center gap-8 lg:gap-[167px] bg-white w-full max-w-[1280px]">
                ...
                <div className="flex-1 max-w-[872px] space-y-10">
                  <div className="flex flex-col items-start gap-4 self-stretch">
                    ...
                    <div className="flex flex-col items-start gap-4">
                      <p className="text-xs text-[#111928] font-albert leading-[140%] max-w-[640px] w-full">Please fill out the form below with your information to create your listing. You'll be asked to choose whether you're listing as a Private Seller or a Dealer. If you're a dealer and would like to use your feed for automatic vehicle listings, please contact us for details.</p>
                    </div>

                    <div ref={dropdownRef} className="w-full max-w-[423px] relative">
                      <div>
                        <button type="button" onClick={() => setOpen((s) => !s)} className="w-full h-[60px] border border-[#B2B2B2] rounded-xl bg-white px-4 py-3 pr-10 text-[15px] font-dm flex items-center justify-between">
                ...
                <div className="w-full md:w-[241px] flex flex-col items-start gap-2">
                  <div className="w-full bg-white border border-[#E4E4E4] rounded-[14px] p-4 flex items-center gap-4 md:bg-transparent md:border-0 md:p-0 md:flex-col md:items-start">
