            ...
            <div className="flex flex-col lg:flex-row justify-end items-center gap-8 lg:gap-[167px] bg-white">
              ...
              <div className="flex-1 max-w-[872px] space-y-10">
                ...
                <div className="space-y-6">
                  <h1 className="text-2xl font-semibold text-[#24272C] font-albert">
                    Get Started with Carzino
                  </h1>
                  <div className="space-y-4">
                    <p className="text-xs text-[#111928] font-albert leading-[140%] max-w-[640px]">
                  ...
                  <div className="w-full max-w-[423px]">
                    <div className="relative">
                      <div className="w-full h-[60px] border border-[#B2B2B2] rounded-xl bg-white px-4 py-3 flex flex-col justify-center">
                        <div className="text-[13px] text-black font-albert font-semibold mb-1">
              ...
              {/* Right Content */}
              <div className="w-full max-w-[241px] flex flex-col items-start gap-4">
