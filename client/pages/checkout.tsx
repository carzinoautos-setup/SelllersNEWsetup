    ...
    <DashboardLayout>
      <div className="flex-1 overflow-visible">
        <div className="pt-8 px-4 sm:px-6 lg:px-8 w-full max-w-[1550px] mx-auto">
          <h1 className="text-[40px] font-bold text-black font-albert leading-[48px] mb-[72px]">
            Check out
          </h1>
          ...
          <div className="flex flex-col xl:flex-row gap-8">
                  ...
                  <div key={item.id} className="border-b border-[#ECEDF2] py-6">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center px-[35px]">
                      ...
                      <div className="md:col-span-5 flex items-center gap-4">
                        <div className="w-[118px] h-[100px] bg-white border border-[#E1E1E1] rounded-2xl flex items-center justify-center flex-shrink-0">
                          <img
                            src={item.image}
                            alt={item.name}
                            className="w-[94px] h-[80px] object-contain"
                          />
                        </div>
                        <div className="font-dm text-base font-medium text-[#050B20]">
                          {item.name}
                        </div>
                      </div>
                      ...
                      <div className="md:hidden flex justify-between">
                        <span className="text-[#050B20] font-dm text-sm">Price:</span>
                        <span className="text-[#050B20] font-dm text-sm">${item.price}</span>
                      </div>
                      ...
                      <div className="md:hidden flex justify-between items-center">
                        <span className="text-[#050B20] font-dm text-sm">Quantity:</span>
                        <div className="flex items-center gap-3">
                          <div className="flex items-center border border-[#E1E1E1] rounded-2xl bg-white h-[54px] w-[165px]">
                            <button
                              onClick={() => updateQuantity(item.id, -1)}
                              className="w-12 h-full flex items-center justify-center text-[#050B20] font-dm text-[15px] hover:bg-gray-50"
                            >
                              -
                            </button>
                            <div className="flex-1 text-center text-[#050B20] font-dm text-[15px]">
                              {item.quantity}
                            </div>
                            <button
                              onClick={() => updateQuantity(item.id, 1)}
                          ...
                          <button
                            ...
                            className="w-[40px] h-[40px] bg-[#F9FBFC] border border-[#E1E1E1] rounded-2xl flex items-center justify-center hover:bg-gray-100"
                          >
                            <DeleteIcon />
                          </button>
                        </div>
                      ...
                      {/* Subtotal - Mobile */}
                      <div className="md:hidden flex justify-between">
                        <span className="text-[#050B20] font-dm text-sm">Subtotal:</span>
                        <span className="text-[#050B20] font-dm text-sm">${item.price * item.quantity}</span>
                      </div>
            ...
            <div className="w-full xl:w-[400px]">
              <div className="bg-white border border-[#E1E1E1] rounded-2xl p-[30px]">
                <h3 className="text-[#050B20] font-albert text-xl font-medium mb-[44px]">
                  Cart Totals
                </h3>
...
function DeleteIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M4.5649 5.81377C4.87487 5.7931 5.1429 6.02763 5.16357 6.3376L5.50853 11.5119C5.57591 12.5228 5.62394 13.2262 5.72937 13.7554C5.83163 14.2688 5.97437 14.5405 6.17944 14.7323C6.3845 14.9241 6.66512 15.0485 7.18412 15.1164C7.71917 15.1864 8.42419 15.1875 9.43729 15.1875H10.0173C11.0304 15.1875 11.7354 15.1864 12.2705 15.1164C12.7895 15.0485 13.0701 14.9241 13.2752 14.7323C13.4802 14.5405 13.623 14.2688 13.7253 13.7554C13.8307 13.2262 13.8787 12.5228 13.9461 11.5119L14.2911 6.3376C14.3117 6.02763 14.5797 5.7931 14.8897 5.81377C15.1997 5.83443 15.4342 6.10246 15.4136 6.41244L15.066 11.6262C15.0018 12.5883 14.9501 13.3654 14.8286 13.9752C14.7023 14.6092 14.4875 15.1388 14.0438 15.5538C13.6001 15.9689 13.0574 16.148 12.4164 16.2319C11.7999 16.3125 11.0211 16.3125 10.0569 16.3125H9.39777C8.43357 16.3125 7.65473 16.3125 7.0382 16.2319C6.39721 16.148 5.85455 15.9689 5.41086 15.5538C4.96716 15.1388 4.75234 14.6092 4.62605 13.9752C4.50456 13.3654 4.45277 12.5883 4.38865 11.6262L4.04106 6.41244C4.02039 6.10246 4.25492 5.83443 4.5649 5.81377Z" fill="#050B20"/>
    </svg>
  );
}
