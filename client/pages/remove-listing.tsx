...
export default function RemoveListing() {
  return (
    <div className="min-h-screen bg-gray-100 flex items-start sm:items-center justify-center p-4 container-minw-0 min-w-0">
      <VisualViewportGuard />
        ...
        <div className="p-[10px] transform scale-[0.7] origin-center md:pt-16 md:px-6 md:pb-6 md:transform md:scale-[1]">
          ...
          <div className="flex justify-center mb-8">
            ...
            >
              ...
              <path
                d="M51.25 22.4622C44.8675 21.8297 38.4467 21.5039 32.045 21.5039C28.25 21.5039 24.455 21.6956 20.66 22.0789L16.75 22.4622"
                stroke="white"
                strokeWidth="1.5"
                strokeLinecap="round"
              ...
              />
              <path
                d="M27.291 20.5245L27.7127 18.0137C28.0193 16.1929 28.2493 14.832 31.4885 14.832H36.5102C39.7494 14.832 39.9985 16.2695 40.286 18.0329L40.7077 20.5245"
                stroke="white"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M47.1294 28.5195L45.8836 47.8204C45.6728 50.8295 45.5003 53.1679 40.1528 53.1679H27.8478C22.5003 53.1679 22.3278 50.8295 22.1169 47.8204L20.8711 28.5195"
                stroke="white"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
