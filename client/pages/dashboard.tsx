        ...
        <div className="w-full max-w-[1290px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col gap-10 w-full max-w-[1290px]">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-7 xl:gap-8">
              ...
              <div className="flex flex-col gap-8 p-8 rounded-2xl border border-[#EDEDED] bg-white w-full max-w-[300px] mx-auto lg:mx-0">
                <div className="flex flex-col gap-5">
                  <img src="https://api.builder.io/api/v1/image/assets/TEMP/3567bf8fc97874a478dd081368b4f20fa2ca862a?width=120" className="w-[60px] h-[60px]" alt="Profile Settings" />
                  <div className="flex flex-col gap-5">
                    <h3 className="text-2xl font-medium text-[#24272C] font-albert">Profile Settings</h3>
                    <p className="text-sm font-normal text-[#696665] font-albert leading-[140%]">Update your personal details, contact information, and preferences to customize your Carzino experience.</p>
                  </div>
                </div>
                <button className="flex justify-center items-center gap-2.5 w-full max-w-[204px] h-[50px] px-4 py-3 rounded-[14px] border border-[#24272C] bg-white text-[#E82121] font-outfit font-medium text-base">
