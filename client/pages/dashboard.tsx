            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-7 xl:gap-8">
              ...
              >
                ...
                <button className="flex justify-center items-center gap-2.5 w-1/2 sm:w-full sm:max-w-[204px] mx-auto sm:mx-0 h-10 sm:h-[50px] px-3 py-2 sm:px-4 sm:py-3 text-xs sm:text-base rounded-[14px] border border-[#2B2825] bg-white text-[#E82121] font-outfit font-medium">
                  ...
                  >
                    <path
                      d="M2.49951 10.0003C2.49951 10.1661 2.56536 10.3251 2.68257 10.4423C2.79978 10.5595 2.95875 10.6253 3.12451 10.6253H15.3659L10.8073 15.1832C10.7493 15.2412 10.7032 15.3102 10.6718 15.386C10.6403 15.4619 10.6242 15.5432 10.6242 15.6253C10.6242 15.7075 10.6403 15.7888 10.6718 15.8647C10.7032 15.9405 10.7493 16.0095 10.8073 16.0675C10.8654 16.1256 10.9343 16.1717 11.0102 16.2031C11.0861 16.2345 11.1674 16.2507 11.2495 16.2507C11.3316 16.2507 11.4129 16.2345 11.4888 16.2031C11.5647 16.1717 11.6336 16.1256 11.6917 16.0675L17.3167 10.4425C17.3748 10.3845 17.4209 10.3156 17.4524 10.2397C17.4838 10.1638 17.5 10.0825 17.5 10.0003C17.5 9.91821 17.4838 9.83688 17.4524 9.76101C17.4209 9.68514 17.3748 9.61621 17.3167 9.55816L11.6917 3.93316C11.5744 3.81588 11.4154 3.75 11.2495 3.75C11.0837 3.75 10.9246 3.81588 10.8073 3.93316C10.69 4.05044 10.6242 4.2095 10.6242 4.37535C10.6242 4.5412 10.69 4.70026 10.8073 4.81753L15.3659 9.37535H3.12451C2.95875 9.37535 2.79978 9.4412 2.68257 9.55841C2.56536 9.67562 2.49951 9.83459 2.49951 10.0003Z"
                      fill="#E82121"
                    />
                  </svg>
                </button>
              ...
              >
                ...
                <button className="flex justify-center items-center gap-2.5 w-1/2 sm:w-full sm:max-w-[204px] mx-auto sm:mx-0 h-10 sm:h-[50px] px-3 py-2 sm:px-4 sm:py-3 text-xs sm:text-base rounded-[14px] border border-black bg-white text-[#E82121] font-outfit font-medium">
                  ...
                  >
                    <path
                      d="M2.99951 10.0003C2.99951 10.1661 3.06536 10.3251 3.18257 10.4423C3.29978 10.5595 3.45875 10.6253 3.62451 10.6253H15.8659L11.3073 15.1832C11.2493 15.2412 11.2032 15.3102 11.1718 15.386C11.1403 15.4619 11.1242 15.5432 11.1242 15.6253C11.1242 15.7075 11.1403 15.7888 11.1718 15.8647C11.2032 15.9405 11.2493 16.0095 11.3073 16.0675C11.3654 16.1256 11.4343 16.1717 11.5102 16.2031C11.5861 16.2345 11.6674 16.2507 11.7495 16.2507C11.8316 16.2507 11.9129 16.2345 11.9888 16.2031C12.0647 16.1717 12.1336 16.1256 12.1917 16.0675L17.8167 10.4425C17.8748 10.3845 17.9209 10.3156 17.9524 10.2397C17.9838 10.1638 18 10.0825 18 10.0003C18 9.91821 17.9838 9.83688 17.9524 9.76101C17.9209 9.68514 17.8748 9.61621 17.8167 9.55816L12.1917 3.93316C12.0744 3.81588 11.9154 3.75 11.7495 3.75C11.5837 3.75 11.4246 3.81588 11.3073 3.93316C11.19 4.05044 11.1242 4.2095 11.1242 4.37535C11.1242 4.5412 11.19 4.70026 11.3073 4.81753L15.8659 9.37535H3.62451C3.45875 9.37535 3.29978 9.4412 3.18257 9.55841C3.06536 9.67562 2.99951 9.83459 2.99951 10.0003Z"
                      fill="#E82121"
                    />
                  </svg>
                </button>
