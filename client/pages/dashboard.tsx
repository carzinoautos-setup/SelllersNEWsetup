      ...
      <div className="flex-1">
        <div className="w-full max-w-[1290px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 items-center justify-center mb-8">
            ...
            {/* View listings */}
            <div className="flex flex-col justify-between gap-4 p-5 md:p-6 rounded-2xl bg-white border border-[#CCCCCC]">
              <div className="flex items-start gap-4">
                <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            {/* Help Center */}
            <div className="flex flex-col justify-center rounded-2xl bg-white border border-[#CCCCCC]" style={{boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1), 0 4px 6px -4px rgba(0,0,0,0.1)', alignItems: 'flex-start', height: 'auto', flexGrow: '0', padding: '10px 11px 10px 12px'}} >
              <div className="flex items-start gap-4">
                <div style={{marginBottom: '-3px'}}>
                  ...
                  <button className="inline-flex items-center px-3 py-1.5 border border-[#CCCCCC] text-[#E82121] bg-transparent rounded-md text-sm font-medium mt-2">Get Help</button>
                </div>
              </div>
