      ...
      <div className="flex-1">
        <div className="w-full max-w-[1290px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 items-center justify-center mb-8">
            ...
            {/* View listings */}
            <div className="flex flex-col justify-between gap-4 p-5 md:p-6 rounded-2xl bg-white border border-[#CCCCCC]" style={{boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1), 0 4px 6px -4px rgba(0,0,0,0.1)'}}>
              <div className="flex items-start gap-4">
                <div>
