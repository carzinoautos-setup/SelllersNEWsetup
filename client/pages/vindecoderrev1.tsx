    ...
    <DashboardLayout>
      <div className="flex-1">
        ...
        <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-12 py-8 overflow-x-hidden">
          ...
          {/* Inserted: Vehicle Details (static, non-stateful) */}
          <div className="mb-12">
            {/* Header */}
            <div className="mb-6">
              <h1
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col gap-2">
                    ...
                    <select className="w-full h-[54px] px-[18px] rounded-lg border border-[#B2B2B2] bg-white text-[14px] text-[#24272C]">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input type="text" placeholder="Enter City" className="w-full h-[54px] px-[18px] py-4 border border-[#B2B2B2] rounded-lg bg-white text-[14px] text-[#050B20]" style={{ fontFamily: "Albert Sans" }} />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input type="text" placeholder="Enter Zip Code" className="w-full h-[54px] px-[18px] py-4 border border-[#B2B2B2] rounded-lg bg-white text-[14px] text-[#050B20]" style={{ fontFamily: "Albert Sans" }} />
                  </div>
                </div>
              </div>
            </div>
