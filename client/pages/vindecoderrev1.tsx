      ...
      <div className="flex-1">
        ...
        <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-12 py-8 overflow-x-hidden">
          ...
          {/* Original Step 1 test header content retained */}
            <h1 style={{ fontFamily: "Albert Sans", fontWeight: 600, fontSize: "20px", lineHeight: "30px" }}>
              <div className="inline text-[#090909] font-semibold">
                Vehicle Feature-
              </div>
              <div className="inline text-[#E82121] font-semibold">
                Step 3
              </div>
            </h1>
              <p
          ...
          <div className="mb-12">
            ...
            <div className="bg-white rounded-2xl pl-[2px]">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-[40px] items-start">
                {/* Features Column */}
                <div className="flex flex-col gap-6">
                  <div>
                    <h3
