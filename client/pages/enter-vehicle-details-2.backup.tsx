...
export default function EnterVehicleDetails2Backup() {
  ...
  function SortableThumbnail({
    ...
    return (
      <div ref={setNodeRef} style={style} {...attributes} {...listeners} className="relative w-28 h-28 rounded-[12px] overflow-hidden bg-gray-50">
        ...
        <button onPointerDown={(e)=>e.stopPropagation()} onTouchStart={(e)=>e.stopPropagation()} onClick={() => deletePhoto(photo.id)} className="absolute bottom-1 right-1 w-6 h-6 bg-black/50 rounded-full flex items-center justify-center text-white shadow">
        ...
        <div className="w-full bg-white border-b border-[#EDEDED]">
          <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-12 py-6">
            <div className="flex flex-wrap items-center gap-2 sm:gap-4">
              <span className="text-[12px] font-bold text-[#090909] leading-[140%]" style={{ fontFamily: 'Albert Sans' }}>
                Your listing:
              </span>
              <span className="text-[12px] font-normal text-[#090909] leading-[140%]" style={{ fontFamily: 'Albert Sans' }}>
                Year Make Model Trim
              </span>
              <span className="text-[12px] font-normal text-black leading-[140%]" style={{ fontFamily: 'Albert Sans' }}>
              ...
              <div>
                ...
                <div className="w-full max-w-[952px] rounded-2xl bg-white py-6 flex flex-col items-center justify-center relative">
                  <div className="flex flex-col items-center gap-4 w-full max-w-[220px]">
                    ...
                    <button
                      type="button"
                      onClick={() => document.getElementById('upload-input-evd2')?.click()}
