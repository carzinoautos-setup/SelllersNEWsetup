    ...
    <DashboardLayout>
      <div className="flex-1">
        <div className="w-full max-w-[1290px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-[60px] py-8">
          <div className="mb-6">
            <h1 className="text-[24px] font-semibold text-[#24272C]">
              Payments
            </h1>
            <p className="text-[14px] text-[#6B6B6B] mt-2">
              Manage saved payment methods and add a new card.
            </p>
          </div>
          ...
          <div className="mb-8 flex justify-center">
            <div className="inline-flex items-start rounded-[30px] bg-white shadow-[0_4px_18px_0_rgba(0,0,0,0.08)] max-w-[924px] w-full overflow-hidden">
              ...
              <div className="flex flex-col p-10 gap-10 bg-white rounded-r-4 flex-1 relative">
                ...
                {/* Title */}
                <h2 className="text-[40px] font-bold leading-[48px] text-[#24272C] font-albert">
                  Register
                </h2>
                ...
                <div className="flex flex-col gap-[30px]">
                  ...
                  <div className="flex flex-col items-center gap-[18px]">
                    ...
                    <div className="text-sm font-albert leading-[19.6px]">
                      ...
                      <span className="text-[#E82121] cursor-pointer">
                        Register
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex w-full items-center gap-6">
                    ...
                    <span className="text-xs text-[#696665] font-albert">
                      or login with
                    </span>
                    <div className="flex-1 h-[1px] bg-[#EFEFEF]"></div>
                  </div>
                    ...
                    <button className="flex flex-1 px-[18px] py-4 justify-center items-center gap-[10px] rounded-full border border-[#EDEDED] bg-white">
                      ...
                      >
                        <g clipPath="url(#clip0_2866_33317)">
                          <path
                            d="M4.43242 12.0875L3.73625 14.6864L1.19176 14.7402C0.431328 13.3298 0 11.7161 0 10.0013C0 8.34301 0.403281 6.77926 1.11812 5.40234H1.11867L3.38398 5.81766L4.37633 8.06938C4.16863 8.67488 4.05543 9.32488 4.05543 10.0013C4.05551 10.7353 4.18848 11.4386 4.43242 12.0875Z"
                            fill="#FBBB00"
                          />
                          <path
                            d="M19.8261 8.13281C19.941 8.73773 20.0009 9.36246 20.0009 10.0009C20.0009 10.7169 19.9256 11.4152 19.7822 12.0889C19.2954 14.3812 18.0234 16.3828 16.2613 17.7993L16.2608 17.7987L13.4075 17.6532L13.0037 15.1323C14.1729 14.4466 15.0866 13.3735 15.568 12.0889H10.2207V8.13281H19.8261Z"
                            fill="#518EF8"
                          />
                          <path
                      ...
                      <span className="text-sm text-[#696665] font-albert font-medium">
                        Google
                      </span>
                    </button>
                    <button className="flex flex-1 px-[18px] py-4 justify-center items-center gap-[10px] rounded-full border border-[#EDEDED] bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white border border-[#E6E6E6] rounded-lg p-6 shadow-sm">
                <h2 className="text-lg font-medium text-[#24272C] mb-4">
                  Add a payment method
                </h2>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm text-[#24272C] mb-2">
                      Cardholder name
                    </label>
                    <input
                      value={cardName}
              ...
              <div className="mt-6 bg-white border border-[#E6E6E6] rounded-lg p-6 shadow-sm">
                ...
                <div className="space-y-3">
                  {cards.map((c) => (
                    <div
                      key={c.id}
                      className="flex items-center justify-between p-3 border border-[#F1F1F1] rounded-md"
                    >
                      <div>
                      ...
                      <div className="flex items-center gap-2">
                        <button className="text-sm text-[#E82121]">
                          Remove
                        </button>
                        <button className="text-sm text-[#6B6B6B]">
                          Set as default
                        </button>
                      </div>
                    </div>
            ...
            <aside className="">
              <div className="bg-white border border-[#E6E6E6] rounded-lg p-6 shadow-sm">
                <h3 className="text-lg font-medium text-[#24272C] mb-2">
                  Billing
                </h3>
                <p className="text-sm text-[#6B6B6B]">
                  Default billing method and recent invoices.
                </p>

                <div className="mt-4">
                  <div className="text-sm text-[#24272C] font-medium">
                    Default: {cards[0]?.brand} •••• {cards[0]?.last4}
                  </div>
