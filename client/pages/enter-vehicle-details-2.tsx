    ...
    <DashboardLayout>
      <div className="flex-1">
        <div className="w-full max-w-[1290px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-[60px] py-8">
          <h1 className="text-[24px] font-semibold text-[#24272C] mb-4">
            Enter Vehicle Details 2
          </h1>
          <p className="text-[14px] text-[#6B6B6B] mb-6">
            Additional vehicle details. Editable fields for quick edits.
          </p>
          ...
          <div className="bg-white border border-[#E6E6E6] rounded-lg p-6 shadow-sm">
            ...
            <div className="mt-6 flex items-center gap-3">
              <button className="inline-flex items-center justify-center h-[44px] px-4 bg-[#E82121] text-white rounded-md">
                Save
              </button>
              <button className="inline-flex items-center justify-center h-[44px] px-4 border border-[#E6E6E6] rounded-md">
                Clear
              </button>
            </div>
          </div>
