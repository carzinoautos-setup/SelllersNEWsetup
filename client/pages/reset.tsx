                      ...
                      <div className="flex items-center gap-[6px]">
                        ...
                        >
                          <circle
                            ...
                            cy="4.5"
                            r="4"
                            fill={hasNumber ? "#7ED321" : "#B6B6B6"}
                          />
                        </svg>
                        <span
                          className={`text-xs font-albert ${hasNumber ? "text-[#7ED321]" : "text-[#B6B6B6]"}`}
                        >
                          One number
                        </span>
                      </div>
                      <div className="flex items-center gap-[6px]">
                        ...
                        >
                          <circle
                            ...
                            cy="4.5"
                            r="4"
                            fill={hasLowercase ? "#7ED321" : "#B6B6B6"}
                          />
                        </svg>
                        <span
                          className={`text-xs font-albert ${hasLowercase ? "text-[#7ED321]" : "text-[#B6B6B6]"}`}
                        >
                      ...
                      <div className="flex items-center gap-[6px]">
                        ...
                        >
                          <circle
                            ...
                            cy="4.5"
                            r="4"
                            fill={hasUppercase ? "#7ED321" : "#B6B6B6"}
                          />
                        </svg>
                        <span
                          className={`text-xs font-albert ${hasUppercase ? "text-[#7ED321]" : "text-[#B6B6B6]"}`}
                        >
                      ...
                      <div className="flex items-center gap-[6px]">
                        ...
                        >
                          <circle
                            ...
                            cy="4.5"
                            r="4"
                            fill={hasMinLength ? "#7ED321" : "#B6B6B6"}
                          />
                        </svg>
                        <span
                          className={`text-xs font-albert ${hasMinLength ? "text-[#7ED321]" : "text-[#B6B6B6]"}`}
                        >
