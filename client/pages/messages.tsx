      ...
      <div className="flex-1">
        <div className="w-full max-w-[1290px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex bg-white rounded-2xl border border-[#EDEDED] overflow-hidden h-[700px]">
            ...
            <div className="w-[444px] flex flex-col border-r border-[#EDEDED]">
              {/* Search */}
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex items-center gap-[10px] p-[30px] pt-0">
                ...
                {/* Attachment Buttons */}
                <button className="w-[52px] h-[52px] bg-[#F3F3F3] rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors">
