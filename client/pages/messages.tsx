  ...
  return (
    <DashboardLayout>
      <div className="flex-1">
        <div className="w-full max-w-[1290px] mx-auto px-4 sm:px-6 lg:px-8 py-8 overflow-x-hidden">
          <div className="mb-6">
          ...
          <div className="flex bg-white rounded-2xl border border-[#EDEDED] overflow-hidden overflow-x-hidden min-h-[500px] md:h-[700px]">
            ...
            <div className={`lg:w-[444px] w-[85%] md:flex md:flex-col flex flex-col md:border-r md:border-[#EDEDED] border-none bg-white md:static fixed md:top-auto top-0 left-0 h-full md:h-auto z-40 transform transition-transform ${showSidebar ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}>
              {/* Search */}
                ...
                <div className="space-y-0">
                  ...
                  <div className="flex items-start gap-5 p-4 hover:bg-gray-50 rounded-lg cursor-pointer">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-[#B6B6B6] font-dm-sans">August 13, 2023</span>
                      </div>
                      <p className="text-sm text-[#696665] font-albert truncate">Lorem ipsum dolor sit amet, consectetur...</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5 p-4 bg-[#F9FCFF] rounded-2xl cursor-pointer">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-[#696665] font-albert truncate">Proin at massa suscipit sem iaculis dignissim...</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5 p-4 hover:bg-gray-50 rounded-lg cursor-pointer">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-[#696665] font-albert truncate">Sed imperdiet tortor sed magna tempus, in...</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5 p-4 hover:bg-gray-50 rounded-lg cursor-pointer">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-[#696665] font-albert truncate">Proin a augue ut leo elementum tincidunt et...</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5 p-4 hover:bg-gray-50 rounded-lg cursor-pointer">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-[#696665] font-albert truncate">Fusce tempor urna dictum ante porta pretium...</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5 p-4 hover:bg-gray-50 rounded-lg cursor-pointer">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-[#696665] font-albert truncate">Mauris facilisis ipsum elementum nulla iaculis...</p>
                    </div>
                  </div>
              ...
              <div className="flex items-center gap-5 h-[114px] px-4 md:px-[50px] py-[10px] border-b border-[#EDEDED]">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-[6px]">
                    ...
                    <span className="text-xs text-[#7ED321] font-albert">Online</span>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col items-end gap-[6px] lg:ml-[300px] ml-0">
                  <div className="bg-[rgba(195,219,243,0.06)] rounded-2xl rounded-br-none p-[14px] max-w-full">
                    <p className="text-sm text-[#24272C] font-albert leading-relaxed">
                      ...
                      Downpayment:<br/>
                      Monthly payment:<br/>
                      If you have more questions, don't hesitate to contact me via this number: 09012345678.<br/>
                      I'm happy to assist!
                    </p>
                  </div>
